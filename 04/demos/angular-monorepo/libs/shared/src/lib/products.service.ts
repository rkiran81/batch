  ...
  public getProducts(): Product[] {
    return [
      ...
      },
      {
        ...
        name: 'Chocoholic',
        description:
          'Deep flavors of dark chocolate are in every bite. With a chocolate cake and fudgey frosting, this cake has it all. Chocoholics, rejoice!',
      },
      {
        id: 4,
      ...
      },
      {
        ...
        description:
          "When strawberries are in season, we celebrate with strawberry in every bite. You don't want to miss this seasonal special!",
      },
      {
        id: 7,
